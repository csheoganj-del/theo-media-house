...
export default function Home() {
  ...
  useEffect(() => {
    // Premium GSAP Stagger Animations for Home
    gsap.fromTo('.home-hero-anim',
      { opacity: 0, y: 50 },
      { opacity: 1, y: 0, duration: 1.4, stagger: 0.25, ease: 'power4.out' }
    );

    gsap.fromTo('.home-card-anim',
      { opacity: 0, y: 40 },
    ...
    <div style={{ backgroundColor: '#000', color: '#fff', overflow: 'hidden' }}>
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 2, padding: '0 2rem' }}>
          ...
          <h1 
            className="home-hero-anim packages-editorial-font"
            style={{
        ...
        <div className="container">
          <div className="tall-packages-grid">
            {categories.map((cat, idx) => (
              <div key={idx} className="tall-package-card home-card-anim">
          ...
          <div className="olive-pricing-grid">
            ...
            <div className="olive-pricing-content olive-fade-right">
              ...
              <p className="olive-desc">
                No matter how you envision your wedding day or how much coverage you require, we have packages to capture every moment, from getting ready to the dance floor celebrations. You can relax knowing that every special moment will be beautifully captured for you to relive over and over.
              </p>
              <p className="olive-desc">
                Getting married outside of Colorado? I'm always up for an adventure! Reach out to learn about my destination wedding packages and travel fees!
              </p>

              <h4 className="olive-subtitle">Whats Included?</h4>
              
              <p className="olive-desc" style={{ marginBottom: '1.5rem', fontWeight: 'bold', color: '#fff' }}>
                Optional engagement session, getting ready photos, full ceremony, family photos, reception photos, sunset couples photos
              </p>
